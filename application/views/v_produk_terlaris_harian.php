    ...
    <center>Lihat Produk Terlaris</center>
</h3>
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div id="laporanPage">
            <form class="form-horizontal" method="post" action="<?= site_url('laporan/cari_produk_terlaris')?>">
                <div class="control-group">
                    <label class="control-label" for="end_date">Pilih Bulan</label>
                    <div class="controls">
                        <input type="month" id="tgl_akhir" name="bulan"required="required">
                    </div>
                </div>
                                            <div class="control-group">
