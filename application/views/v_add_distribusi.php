<!--
            ...
            <?php foreach($this->cart->contents() as $items): ?>
                ...
                <tr class="gradeX">
                    ...
                    <td>
                        <a class="btn btn-mini btn-danger btn-block delbutton" href="<?php $a= $items['rowid']; echo site_url('distribusi/delete_cart/'.$a) ?>" class="delbutton"
                           id="<?php echo 'tambah/'.$items['rowid'].'/'.$kd_distribusi.'/'.$items['id'].'/'.$items['qty']; ?>">
            ...
            <?php endforeach; ?>
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo site_url('distribusi/simpan_distribusi') ?>">
                            <fieldset>
                            <div class="row-fluid">
                            <div class="span6">
                            <div class="well">
                    ...
                    <input type="hidden" name="kd_distribusi" value="<?= $kd_distribusi; ?>" readonly>
...
<!--modal add barang-->
    ...
    <form id="frm" name="frm"  method="post" action="<?php echo site_url('distribusi/tambah_distribusi_to_cart')?>">
        <div class="modal-body" style="min-height: 200px">
                        <div class="control-group">
                                <label class="control-label" for="selectError">Pilih Outlet</label>
                                <div class="controls">
                                  <select id="kd_barang" data-rel="chosen" data-placeholder="Pilih Rasa">
    ...
    $(document).ready(function() {
        $("#kd_barang").change(function(){
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo base_url('distribusi/get_detail_barang'); ?>",
...
<!--=====================================================================================-->
                ...
                <div class="box span12">
                    ...
                    <div class="box-content">    
                        <form id="form_transaksi" class="form-horizontal" method="post" action="<?php echo site_url('distribusi/simpan_distribusi');?>">
                            <fieldset>
                            <div class="control-group">
                                <label class="control-label" for="selectError">Daftar Outlet</label>
                                <div class="controls">
 ...
 <?php
    if(isset($data_daftar_barang)){
        foreach($data_daftar_barang as $row){
           ...
           <option value="<?php echo $row->kd_barang ?>"><?php echo $row->nm_barang?></option>
        <?php
           $stok .= "s['" . $row->kd_barang . "'] = {stok:'".addslashes($row->stok)."'};\n";
           $nama .= "n['" . $row->kd_barang . "'] = {n:'".addslashes($row->nm_barang)."'};\n";
           $harga_jual .= "h['" . $row->kd_barang . "'] = {h:'".addslashes($row->harga_jual)."'};\n";
...
<script type="text/javascript">  
<?php echo $stok; echo $harga_jual;echo $nama;?>
function changeValue(id){
document.getElementById('stok').value = s[id].stok;
...
<input id="nm_barang" readonly="" name="nm_barang" class="input-xlarge focused" id="focusedInput" type="hidden" value="">                                  
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="stok" name="stok" type="text" readonly="" class="reset">
                                    </div>
                                </div>
                              <div class="control-group">
